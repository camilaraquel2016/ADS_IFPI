...
export class Banco {
    ...
    associarUmClienteAUmaConta(numConta, cpfCliente) {
        ...
        if (contaExiste && clienteExiste) {
            if (contaExiste.getCliente().getId() == clienteExiste.getId()) {
                ...
                const antigoDono = contaExiste.getCliente();
                antigoDono.removerConta(contaExiste);
                const novoDono = clienteExiste;
